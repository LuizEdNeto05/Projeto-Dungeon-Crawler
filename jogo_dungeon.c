							...
							else 
							{
								...
								else 
								{
									...
									else 
									{
										...
										//espinhos
										if(i==1 && j ==14 || i==2 && j ==14 || i==3 && j ==14 || i==4 && j ==14 || i==5 && j ==14 ||i==6 && j ==14 ||i==7 && j ==14 ||i==8 && j ==14 ||i==9 && j ==14 || i==10 && j==14||i==11 && j==14)
										{
											matriz3[i][j] = '#';
										}
										...
										if(i == 32 && j == 6|| i == 32 && j == 7||i == 32 && j == 8||i == 32 && j == 9||i == 32 && j == 11||i == 32 && j == 5||i == 32 && j == 4||i == 32 && j == 3||i == 32 && j == 2||i == 32 && j == 1)
										{
											matriz3[i][j] = '#';
										}
				...
				else 
				{
					...
					npcMove();
						...
						int f;
						 ...
						 printf("\n\t\t\t\t\t|A FINALIZACAO CONTEM 15 SEGUNDOS, ESPERE PARA VOLTAR PARA O MENU PRINCIPAL!|");
						 Sleep(15000);
